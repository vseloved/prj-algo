...
Задание 3: Реализовать алгоритм сортировки деревом, который заключается в построение дерева бинарного поиска (любого варианта из реализаций) и обходе его в порядке in-order. Сколько операций нужно вашему алгоритму в среднем и худшем случае?
