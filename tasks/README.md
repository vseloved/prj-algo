...
Задание: записать правила грамматики регулярных выражений и осуществить их разбор на основе этой грамматики с помощью алгоритма shirt-reduce. Результатом разбора будет дерево разбора, которое нужно отобразить, а также запись выражения в постфиксной форме (как в задании 15).
